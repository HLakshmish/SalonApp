...
import { K as require_browser_external_node_module, X as require_browser_external_node_fs, Y as require_browser_external_node_url } from "./experimental-index-DzWW3X3X.js";
...
var { version } = JSON.parse((0, import_browser_external_node_fs.readFileSync)(new URL("../../package.json", new URL("../../node_modules/vite/src/node/constants.ts", import.meta.url))).toString());
var ROLLUP_HOOKS = [
	"options",
	"buildStart",
	"buildEnd",
...
var VITE_PACKAGE_DIR = (0, import_browser_external_node_path.resolve)((0, import_browser_external_node_url.fileURLToPath)(new URL("../../node_modules/vite/src/node/constants.ts", import.meta.url)), "../../..");
...
//# sourceMappingURL=logger-D6Y4A4Fs.js.map